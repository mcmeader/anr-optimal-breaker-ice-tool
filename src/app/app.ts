...
export class App implements OnInit, AfterViewInit {
  ...
  displayedColumns2: string[] = ['name', 'encounterType', 'subroutines', 'text'];
  ...
  ngOnInit(): void {
    ...
    const val = [
      {
        ...
        strength: 6,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Do 1 core damage. Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Heimdall 1.0',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Trash 1 installed program. Subroutine Trash 1 installed program. Subroutine Trace[1]. If successful, do 1 core damage and give the Runner 1 tag.',
        stripped_title: 'Ichi 1.0',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Do 1 core damage. Subroutine End the run.',
        stripped_title: 'Viktor 1.0',
        text: '<strong>Lose [click]:</strong> Break 1 subroutine on this ice. Only the Runner can use this ability.\n[subroutine] Do 1 core damage.\n[subroutine] End the run.',
        title: 'Viktor 1.0',
        type_code: 'ice',
        uniqueness: false,
      },
      {
        ...
        side_code: 'corp',
        strength: 0,
        stripped_text: 'Subroutine Trash 1 installed program. Subroutine End the run.',
        stripped_title: 'Rototurret',
      ...
      },
      {
        ...
        strength: 7,
        stripped_text:
          'Subroutine The Runner moves to the outermost position of the attacked server. They may jack out. Derez this ice.',
        stripped_title: 'Cell Portal',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine The next piece of ice the Runner encounters during this run gets +2 strength. When that encounter ends, if the Runner did not fully break that ice, do 3 net damage.',
        stripped_title: 'Chum',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 2,
        stripped_text: 'Subroutine Do 1 net damage. Trash Data Mine.',
        stripped_title: 'Data Mine',
      ...
      },
      {
        ...
        faction_cost: 2,
        flavor:
          'Forged by Ak.wa on 23.11.79-23. Filed 23.11.79-23.2 with #34k-lw3-21HH-4i.\n//Samurai included.',
        ...
        side_code: 'corp',
        strength: 3,
        stripped_text: 'Subroutine Do 3 net damage.',
        stripped_title: 'Neural Katana',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 5,
        stripped_text: 'Subroutine Do 2 net damage. Subroutine End the run.',
        stripped_title: 'Wall of Thorns',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'When the Runner encounters this ice, they must take 1 tag or end the run. Hosted power counter: Give the Runner 1 tag. Subroutine Trace[3]. If successful, place 1 power counter on this ice.',
        stripped_title: 'Data Raven',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'When the Runner encounters Matrix Analyzer, you may pay 1 credit to place 1 advancement token on a card that can be advanced. Subroutine Trace[2]. If successful, give the Runner 1 tag.',
        stripped_title: 'Matrix Analyzer',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'When the Runner encounters this ice, they must pay 3 credits, if able. If they do not, end the run. Subroutine End the run.',
        stripped_title: 'Tollbooth',
      ...
      },
      {
        ...
        strength: 7,
        stripped_text:
          "Hadrian's Wall can be advanced and has +1 strength for each advancement token on it. Subroutine End the run. Subroutine End the run.",
        stripped_title: "Hadrian's Wall",
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'You can advance this ice. It gets +1 strength for each hosted advancement counter. Subroutine End the run.',
        stripped_title: 'Ice Wall',
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'Shadow can be advanced and has +1 strength for each advancement token on it. Subroutine The Corp gains 2 credits. Subroutine Trace[3]. If successful, give the Runner 1 tag.',
        stripped_title: 'Shadow',
      ...
      },
      {
        ...
        faction_cost: 0,
        flavor:
          '"Hey, hey! Wake up, man. You were under a long time. What\'d you see?"\n"I…don\'t remember."',
        ...
        side_code: 'corp',
        strength: 2,
        stripped_text: 'Subroutine The Runner loses click. Subroutine End the run.',
        stripped_title: 'Enigma',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 4,
        stripped_text: 'Subroutine Trace[3]. If successful, give the Runner 1 tag.',
        stripped_title: 'Hunter',
      ...
      },
      {
        ...
        faction_cost: 0,
        flavor:
          '"There\'s nothing worse than seeing that beautiful blue ball of data just out of reach as your connection derezzes. I think they do it just to taunt us." -Ele "Smoke" Scovak',
        illustrator: 'Adam S. Doyle',
        keywords: 'Barrier',
        pack_code: 'core',
        position: 113,
      ...
      },
      {
        ...
        strength: 8,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Do 1 core damage. Subroutine Do 1 core damage. Subroutine Do 1 core damage. Subroutine Do 1 core damage.',
        stripped_title: 'Janus 1.0',
        text: '<strong>Lose [click]:</strong> Break 1 subroutine on this ice. Only the Runner can use this ability.\n[subroutine] Do 1 core damage.\n[subroutine] Do 1 core damage.\n[subroutine] Do 1 core damage.\n[subroutine] Do 1 core damage.',
        title: 'Janus 1.0',
        type_code: 'ice',
        uniqueness: false,
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine You and the Runner secretly spend 0 credits, 1 credit, or 2 credits. Reveal spent credits. End the run if you and the Runner spent a different number of credits.',
        stripped_title: 'Snowflake',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'When you rez TMI, Trace[2]. If unsuccessful, derez TMI. Subroutine End the run.',
        stripped_title: 'TMI',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine Trace[3]. If successful, the Corp gains 3 credits. Subroutine Trace[2]. If successful, end the run.',
        stripped_title: 'Caduceus',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'When you rez this ice, you may spend any number of credits to place that many power counters on it. This ice gets +1 strength for each hosted power counter. Subroutine Trace[2]. If successful, give the Runner 1 tag and end the run.',
        stripped_title: 'Draco',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          "Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Trace[4]. If successful, add 1 installed program to the top of the Runner's stack. Subroutine Trace[4]. If successful, add 1 installed program to the top of the Runner's stack.",
        stripped_title: 'Sherlock 1.0',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine For the remainder of this run, while the Runner is encountering another piece of ice, it gains "Subroutine End the run." after its other subroutines.',
        stripped_title: 'Sensei',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Trace[3]. If successful, the Runner loses click, if able. Subroutine Trace[3]. If successful, end the run.',
        stripped_title: 'Viper',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'When the Runner encounters this ice, gain 1 credit. Subroutine End the run unless the Runner pays 1 credit.',
        stripped_title: 'Pop-up Window',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'You can advance this ice if it is rezzed. It gains "Subroutine Do 1 net damage." for each hosted advancement counter.',
        stripped_title: 'Woodcutter',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'When you rez Chimera, choose sentry, code gate, or barrier. Chimera gains that subtype until derezzed. When a turn ends, derez Chimera. Subroutine End the run.',
        stripped_title: 'Chimera',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine The Runner loses click, if able. Subroutine The Runner loses click, if able. Subroutine The Runner loses click, if able.',
        stripped_title: 'Hourglass',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine You and the Runner secretly spend 0 credits, 1 credit or 2 credits. Reveal spent credits. If you and the Runner spent a different number of credits and this ice is installed, move this ice to the outermost position protecting another server. (The run continues from this new position.)',
        stripped_title: 'Bullfrog',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Trace[4]. If successful, the Runner cannot make another run this turn. Subroutine Trace[4]. If successful, end the run.',
        stripped_title: 'Uroboros',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'You can advance this ice if it is rezzed. It gains "Subroutine End the run." for each hosted advancement counter.',
        stripped_title: 'Tyrant',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          "Subroutine Trace[2]. If successful, look at the top X cards of the stack, where X is equal to the amount by which your trace strength exceeded the Runner's link strength. Trash 1 of those cards and arrange the rest in any order.",
        stripped_title: 'Data Hound',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'You can advance this ice if it is rezzed. It gains "Subroutine Trace[2]. If successful, give the Runner 1 tag." for each hosted advancement counter.',
        stripped_title: 'Salvage',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine End the run. Subroutine End the run.',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 0,
        stripped_text: 'Subroutine Trace[0]. If successful, the Runner trashes 1 program.',
        stripped_title: 'Burke Bugs',
      ...
      },
      {
        ...
        strength: 7,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine Do 1 core damage. Subroutine Do 1 core damage and end the run. Subroutine End the run.',
        stripped_title: 'Heimdall 2.0',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Subroutine You may install and rez 1 piece of bioroid ice from HQ or Archives directly inward from this ice, ignoring all costs. When this run ends, if you installed a piece of ice this way, trash this ice and derez the ice you installed.',
        stripped_title: 'Howler',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine Trash 1 installed program. Subroutine Trash 1 installed program. Subroutine Trace[3]. If successful, do 1 core damage and give the Runner 1 tag.',
        stripped_title: 'Ichi 2.0',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine You may install 1 piece of ice from HQ protecting this server, ignoring the install cost.',
        stripped_title: 'Minelayer',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Hosted power counter: Do 1 core damage. Subroutine Trace[2]. If successful, place 1 power counter on this ice. Subroutine End the run.',
        stripped_title: 'Viktor 2.0',
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine If the Runner has lost click to break a subroutine during this run, do 1 core damage. Subroutine If the Runner has lost click to break a subroutine during this run, do 1 core damage.',
        stripped_title: 'Zed 1.0',
      ...
      },
      {
        ...
        faction_cost: 0,
        flavor:
          "The principle behind ice is not to keep everyone out, but to let only some people in. This ice denies entry on all but a select few ports that might change with the time of day or picosecond of connection. If you don't know what port to use, you're not getting in. Period.",
        illustrator: 'Ed Mattinian',
        keywords: 'Barrier',
        pack_code: 'cac',
        position: 26,
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Subroutine The Runner must pay 2 credits, if able. If the Runner cannot pay 2 credits, end the run. Subroutine End the run.',
        stripped_title: 'Datapike',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'NEXT Bronze has +1 strength for each rezzed piece of NEXT ice. Subroutine End the run.',
        stripped_title: 'NEXT Bronze',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 2,
        stripped_text: '1 credit: Add Himitsu-Bako to HQ. Subroutine End the run.',
        stripped_title: 'Himitsu-Bako',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'When you rez this ice, take 1 bad publicity. You can advance this ice. It gains "Subroutine Trash 1 installed program unless the Runner pays 3 credits." for each hosted advancement counter.',
        stripped_title: 'Swarm',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'When you rez this ice, take 1 bad publicity. Subroutine Trash 1 installed program.',
        stripped_title: 'Grim',
        text: 'When you rez this ice, take 1 bad publicity.\n[subroutine] Trash 1 installed program.',
        title: 'Grim',
        type_code: 'ice',
      ...
      },
      {
        ...
        strength: 10,
        stripped_text:
          'Subroutine End the run unless the Runner spends click click. Subroutine End the run unless the Runner pays 3 credits. Subroutine End the run unless the Runner trashes 1 installed program. Subroutine End the run unless the Runner suffers 1 core damage.',
        stripped_title: 'Wotan',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'The Runner cannot break subroutines on this ice using AI programs. Subroutine Trash 1 installed AI program. Subroutine Do 1 net damage.',
        stripped_title: 'Swordsman',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine The Runner cannot access more than 1 card during this run. Subroutine The Runner cannot access more than 1 card during this run.',
        stripped_title: 'Hudson 1.0',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          "When the Runner encounters Snoop, reveal all cards in the Runner's grip. Hosted power counter: Reveal all cards in the Runner's grip. Trash 1 of those cards. Subroutine Trace[3]. If successful, place 1 power counter on Snoop.",
        stripped_title: 'Snoop',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'This ice gains "Subroutine The Runner loses 1 credit." for each bad publicity you have.',
        stripped_title: 'Ireress',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'When the Runner fully breaks this ice, trash it. Subroutine End the run.',
        stripped_title: 'Paper Wall',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'When you rez this ice, take 1 bad publicity. Subroutine Do 1 core damage. Subroutine End the run.',
        stripped_title: 'Fenris',
        text: 'When you rez this ice, take 1 bad publicity.\n[subroutine] Do 1 core damage.\n[subroutine] End the run.',
        title: 'Fenris',
        type_code: 'ice',
        uniqueness: false,
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Subroutine End the run unless the Corp pays 1 credit. Subroutine Do 1 net damage. Subroutine Do 1 net damage. Subroutine Do 1 net damage.',
        stripped_title: 'Tsurugi',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine The Runner cannot spend any credits for the remainder of this run.',
        stripped_title: 'RSVP',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'If Curtain Wall is the outermost piece of ice protecting a server, it has +4 strength. Subroutine End the run. Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Curtain Wall',
      ...
      },
      {
        ...
        faction_cost: 2,
        flavor:
          "The 'cyber-war' is a war of information, and in a war of information, advance warning can be as good as a killing blow. -Michael Muhama, Musings on Cybercrime",
        illustrator: 'Andrew Mar',
        ...
        strength: 0,
        stripped_text:
          'Subroutine Look at the top card of R&D. You may add that card to the bottom of R&D. Subroutine Do 1 net damage.',
        stripped_title: 'Yagura',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'While there are no installed fracter programs, this ice gets +7 strength. Subroutine End the run.',
        stripped_title: 'Wraparound',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          "Subroutine The Runner's maximum hand size is reduced by 2 until the beginning of the Corp's next turn.",
        stripped_title: 'Gyri Labyrinth',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'When you rez this ice, take 1 bad publicity. Subroutine Trace[1]. If successful, do 1 net damage. Subroutine Trace[2]. If successful, do 2 net damage. Subroutine Trace[3]. If successful, do 3 net damage and end the run.',
        stripped_title: 'Shinobi',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine The next piece of ice the Runner encounters during this run gains "Subroutine End the run." after its other subroutines for the remainder of that run.',
        stripped_title: 'Marker',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'This ice loses 1 of its printed "Subroutine End the run." subroutines for each agenda point in your score area. Subroutine End the run. Subroutine End the run. Subroutine End the run. Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Hive',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine During the next encounter this run, the Runner cannot break subroutines on the encountered ice. Subroutine The Runner cannot jack out this run until after their next encounter with a piece of ice begins.',
        stripped_title: 'Inazuma',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Subroutine Do 1 net damage unless the Runner pays 1 credit. Subroutine Do 1 net damage unless the Runner pays 1 credit.',
        stripped_title: 'Pup',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine Look at the top 3 cards of R&D and arrange them in any order. Subroutine You may pay 1 credit. If you do not, the Runner breaches R&D. They cannot access cards in the root of R&D during that breach.',
        stripped_title: 'Shiro',
      ...
      },
      {
        ...
        stripped_title: 'Susanoo-no-Mikoto',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 2,
        stripped_text: 'Guard cannot be bypassed. Subroutine End the run.',
        stripped_title: 'Guard',
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'This ice gains "Subroutine End the run." for each rezzed piece of NEXT ice.',
        stripped_title: 'NEXT Silver',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 4,
        stripped_text: 'The strength of this ice cannot be lowered. Subroutine End the run.',
        stripped_title: 'Lotus Field',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Mother Goddess gains the subtypes of all other rezzed ice. Subroutine End the run.',
        stripped_title: 'Mother Goddess',
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'When the Runner encounters this ice, you may reveal up to 2 pieces of grail ice in HQ. For the remainder of this run, this ice gains the subroutines of each revealed piece of ice in the order of your choice. Subroutine End the run.',
        stripped_title: 'Galahad',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'When the Runner encounters this ice, Trace[1]. If successful, give them 1 tag. This ice gains "Subroutine The Runner trashes 1 of their installed cards." for each tag the Runner has.',
        stripped_title: 'Information Overload',
      ...
      },
      {
        ...
        faction_cost: 2,
        flavor:
          "Created by merging the brainscans of over a hundred of the most intelligent people in Haas-Bioroid's cerebral database, its effectiveness is limited either by its lack of imagination or the imagination of the sysops who employ it.",
        ...
        strength: 0,
        stripped_text:
          'The rez cost of IQ is increased by 1 for each card in HQ. IQ has +1 strength for each card in HQ. Subroutine End the run.',
        stripped_title: 'IQ',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine You may choose 1 card in HQ. If you do, the Runner breaches HQ. During this breach, the Runner cannot access cards in the root of HQ, and the first card they access must be the chosen card. When the breach ends, trash this ice.',
        stripped_title: 'Kitsune',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Wendigo can be advanced. While Wendigo has an odd number of advancement tokens on it, it gains barrier and loses code gate. Subroutine Choose a program. The Runner cannot use the chosen program for the remainder of this run.',
        stripped_title: 'Wendigo',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'When the Runner encounters this ice, you may reveal up to 2 pieces of grail ice in HQ. For the remainder of this run, this ice gains the subroutines of each revealed piece of ice in the order of your choice. Subroutine Trash 1 installed program.',
        stripped_title: 'Lancelot',
        text: 'When the Runner encounters this ice, you may reveal up to 2 pieces of <strong>grail</strong> ice in HQ. For the remainder of this run, this ice gains the subroutines of each revealed piece of ice in the order of your choice.\n[subroutine] Trash 1 installed program.',
        title: 'Lancelot',
        type_code: 'ice',
        uniqueness: false,
      },
      {
        ...
        faction_code: 'haas-bioroid',
        faction_cost: 2,
        flavor: '<strong>Designed by 2012 World Champion Jeremy Zwirn</strong>',
        ...
        strength: 3,
        stripped_text:
          'Players cannot trash this ice. Subroutine Look at the top 5 cards of R&D. You may install 1 of those cards, ignoring the install cost. Subroutine You may install 1 card from Archives or HQ.',
        stripped_title: 'Architect',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 4,
        stripped_text: 'This ice gains "Subroutine End the run." for each card in HQ.',
        stripped_title: 'Ashigaru',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Hosted power counter: Do 1 net damage. Use this ability only during a run. Subroutine Do 1 net damage. Subroutine You and the Runner secretly spend 0 credits, 1 credit, or 2 credits. Reveal spent credits. If you and the Runner spent a different number of credits, place 1 power counter on Mamba.',
        stripped_title: 'Mamba',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Subroutine If the Runner is not tagged, they lose 1 credit. If the Runner is tagged, they lose all credits in their credit pool and you trash this ice.',
        stripped_title: 'Universal Connectivity Fee',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Changeling can be advanced. While Changeling has an odd number of advancement tokens on it, it gains sentry and loses barrier. Subroutine End the run.',
        stripped_title: 'Changeling',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Trace[2]. If successful, trash 1 program. If your trace strength is 5 or greater, trash 1 program.',
        stripped_title: 'Sagittarius',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Lycan can be advanced. While Lycan has an odd number of advancement tokens on it, it gains code gate and loses sentry. Subroutine Trash 1 program.',
        stripped_title: 'Lycan',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'When the Runner encounters this ice, you may reveal up to 2 pieces of grail ice in HQ. For the remainder of this run, this ice gains the subroutines of each revealed piece of ice in the order of your choice. Subroutine Do 2 net damage.',
        stripped_title: 'Merlin',
      ...
      },
      {
        ...
        faction_cost: 1,
        flavor:
          'Recycling the energy entering the system via a run is both responsible and economical.',
        ...
        strength: 1,
        stripped_text:
          'Subroutine The Corp gains 1 credit or draws 1 card. Subroutine The Corp gains 1 credit or draws 1 card. Subroutine The Corp gains 1 credit or draws 1 card.',
        stripped_title: 'Errand Boy',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine The Runner trashes 1 of their installed cards. Subroutine End the run.',
        stripped_title: 'Markus 1.0',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 3,
        stripped_text: 'Subroutine The Runner cannot make another run this turn.',
        stripped_title: 'Excalibur',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'Asteroid Belt can be advanced and its rez cost is lowered by 3 for each advancement token on it. Subroutine End the run.',
        stripped_title: 'Asteroid Belt',
      ...
      },
      {
        ...
        strength: 7,
        stripped_text:
          'Wormhole can be advanced and its rez cost is lowered by 3 for each advancement token on it. Subroutine Resolve a subroutine on another piece of rezzed ice.',
        stripped_title: 'Wormhole',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Nebula can be advanced and its rez cost is lowered by 3 for each advancement token on it. Subroutine Trash 1 program.',
        stripped_title: 'Nebula',
      ...
      },
      {
        ...
        strength: 8,
        stripped_text:
          'Orion can be advanced and its rez cost is lowered by 3 for each advancement token on it. Subroutine Trash 1 program. Subroutine Resolve a subroutine on another piece of rezzed ice. Subroutine End the run.',
        stripped_title: 'Orion',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'click: Move this piece of ice to the outermost position protecting any server. Subroutine Place 1 advancement token on a piece of ice protecting this server that can be advanced. Subroutine Place 1 advancement token on a piece of ice protecting this server that can be advanced.',
        stripped_title: 'Builder',
      ...
      },
      {
        ...
        strength: 7,
        stripped_text:
          'When you rez this ice, take 1 bad publicity. Subroutine Trace[5]. If successful, do 3 meat damage when this run becomes successful.',
        stripped_title: 'Checkpoint',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Fire Wall can be advanced and gains +1 strength for each advancement token on it. Subroutine End the run.',
        stripped_title: 'Fire Wall',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Searchlight can be advanced. X is the number of advancement tokens on Searchlight. Subroutine Trace[X]. If successful, give the Runner 1 tag. Subroutine Trace[X]. If successful, give the Runner 1 tag.',
        stripped_title: 'Searchlight',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'X is the number of rezzed NEXT ice. Subroutine Do X net damage. Subroutine Trash X programs.',
        stripped_title: 'NEXT Gold',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 4,
        stripped_text: 'Subroutine Do 1 net damage for each unused MU the Runner has.',
        stripped_title: 'Cortex Lock',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          '2 credits: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Gain 2 credits. Subroutine Trash 1 installed program.',
        stripped_title: 'Negotiator',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Turing has +3 strength while protecting a remote server. The Runner cannot use AI programs to break subroutines on Turing. Subroutine End the run unless the Runner spends click click click.',
        stripped_title: 'Turing',
      ...
      },
      {
        ...
        faction_cost: 3,
        flavor:
          'Crick and his colleagues ushered in modern genetics by mapping the structure of DNA.',
        illustrator: 'Ed Mattinian',
        keywords: 'Code Gate',
        pack_code: 'bb',
        position: 34,
        ...
        strength: 3,
        stripped_text:
          'Crick has +3 strength while protecting Archives. Subroutine Install a card from Archives (paying its install cost).',
        stripped_title: 'Crick',
      ...
      },
      {
        ...
        faction_cost: 3,
        flavor:
          'Johannes Gutenberg ignited the first Information Revolution by inventing the movable-type printing press.',
        illustrator: 'Adam S. Doyle',
        keywords: 'Sentry - Tracer',
        pack_code: 'bb',
        position: 37,
        ...
        strength: 3,
        stripped_text:
          'Gutenberg has +3 strength while protecting R&D. Subroutine Trace[7]. If successful, give the Runner 1 tag.',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'Meru Mati has +3 strength while protecting HQ. Subroutine End the run.',
        stripped_title: 'Meru Mati',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine You and the Runner secretly spend 0 credits, 1 credit, or 2 credits. Reveal spent credits. If you and the Runner spent a different number of credits, place 1 advancement token on an installed card and end the run.',
        stripped_title: 'Clairvoyant Monitor',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 5,
        stripped_text: 'Subroutine The Runner cannot draw cards for the remainder of this turn.',
        stripped_title: 'Lockdown',
      ...
      },
      {
        ...
        strength: 7,
        stripped_text:
          'Subroutine End the run. Subroutine End the run. Subroutine The Runner gains 5 credits.',
        stripped_title: 'Little Engine',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'When the Runner encounters Quicksand, place 1 power counter on Quicksand. Quicksand has +1 strength for each power counter on it. Subroutine End the run.',
        stripped_title: 'Quicksand',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine End the run if the Runner is tagged. Subroutine End the run if the Runner is tagged.',
        stripped_title: 'Pachinko',
      ...
      },
      {
        ...
        faction_cost: 2,
        flavor:
          '"Let me tell you a secret. There\'s no such thing as impenetrable ice. It has to allow access, or else why is the server on the Network in the first place? But that doesn\'t mean they have to make it easy." -g00ru',
        illustrator: 'Laura Wilson',
        keywords: 'Barrier',
        pack_code: 'uw',
        position: 79,
        ...
        side_code: 'corp',
        strength: 2,
        stripped_text: 'Subroutine End the run. Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Spiderweb',
        text: '[subroutine] End the run.\n[subroutine] End the run.\n[subroutine] End the run.',
        title: 'Spiderweb',
        type_code: 'ice',
        uniqueness: false,
      },
      {
        ...
        strength: 5,
        stripped_text:
          'As an additional cost to rez this ice, forfeit 1 agenda. Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Trash 1 installed program. Subroutine Do 1 core damage. Subroutine Trash 1 installed console. Subroutine Trash all installed virtual resources.',
        stripped_title: 'Enforcer 1.0',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Whenever this ice is exposed, do 2 net damage. Subroutine The Runner trashes 1 of their installed cards. Trash this ice.',
        stripped_title: "It's a Trap!",
      ...
      },
      {
        ...
        faction_cost: 2,
        flavor:
          '"Hello, and welcome to the Universe of Tomorrow! You could live for five-hundred years and not see all of the attractions I can tell you about."',
        ...
        side_code: 'corp',
        strength: 0,
        stripped_text: 'This ice gains "Subroutine End the run." for each rezzed asset.',
        stripped_title: 'Tour Guide',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'While the Runner is accessing this ice in R&D, they must reveal it. When the Runner accesses this ice anywhere except in Archives, you may pay 3 credits. If you do, they encounter it. Subroutine Trace[6]. If successful, add 1 installed Runner card to the grip.',
        stripped_title: 'Archangel',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Trace[3]. If successful, give the Runner 1 tag. If a current is active, this ice gains "Subroutine End the run." after its other subroutines.',
        stripped_title: 'News Hound',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Resistor has +1 strength for each tag the Runner has. Subroutine Trace[4]. If successful, end the run.',
        stripped_title: 'Resistor',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 3,
        stripped_text: 'Subroutine The Corp gains 5 credits. Trash Special Offer.',
        stripped_title: 'Special Offer',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine The next time the Runner encounters a piece of ice during this run, that ice gains a second copy of each of its subroutines (after the original subroutine) for the remainder of that encounter.',
        stripped_title: 'TL;DR',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'When the Runner encounters this ice, they lose 1 credit. Subroutine Trace[5]. If successful, give the Runner 1 tag.',
        stripped_title: 'Turnpike',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine Trace[5]. If successful, do 3 net damage. Subroutine Trace[4]. If successful, trash 1 program.',
        stripped_title: 'Assassin',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine The Runner cannot use programs for the remainder of this run. Subroutine Trace[4]. If successful, do 1 core damage. Subroutine Trace[4]. If successful, do 1 core damage.',
        stripped_title: 'Vikram 1.0',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine For the remainder of this run, as an additional cost to use an icebreaker ability to break subroutines, the Runner must pay 1 credit. Subroutine For the remainder of this run, as an additional cost to use an icebreaker ability to break subroutines, the Runner must pay 1 credit',
        stripped_title: 'Interrupt 0',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine The Runner draws 3 cards and then discards down to their maximum hand size. Subroutine The Runner draws 3 cards and then discards down to their maximum hand size.',
        stripped_title: 'Harvester',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Whenever the Runner breaks a subroutine on Bailiff, gain 1 credit. Subroutine End the run.',
        stripped_title: 'Bailiff',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine You and the Runner secretly spend 0 credits, 1 credit, or 2 credits. Reveal spent credits. If you and the Runner spent a different number of credits, the Runner loses 2 credits. Subroutine Resolve a subroutine on a piece of rezzed psi ice.',
        stripped_title: 'Upayoga',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'Subroutine Trash 1 program. Subroutine Do 2 net damage.',
        stripped_title: 'Cobra',
      ...
      },
      {
        ...
        faction_code: 'haas-bioroid',
        faction_cost: 4,
        flavor: 'has anyone heard from StatiX lately?\n-post on Members Only newsgroup',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Resolve 1 subroutine on another rezzed bioroid ice. Subroutine Resolve 1 subroutine on another rezzed bioroid ice.',
      ...
      },
      {
        ...
        faction_code: 'jinteki',
        faction_cost: 2,
        flavor: '"Feel your consciousness expand and touch his. Now destroy it."',
        illustrator: 'Adam S. Doyle',
        ...
        strength: 3,
        stripped_text:
          "Subroutine Each player gains 2 credits. Subroutine You and the Runner secretly spend 0 credits, 1 credit, or 2 credits. Reveal spent credits. If you and the Runner spent a different number of credits, do 1 net damage for each card in the Runner's grip.",
        stripped_title: 'Chetana',
      ...
      },
      {
        ...
        faction_code: 'nbn',
        faction_cost: 2,
        flavor: '"It\'s amazing how small we can write the fine print these days."',
        illustrator: 'Lili Ibrahim',
        keywords: 'Code Gate - Tracer',
        pack_code: 'tlm',
        position: 91,
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 5,
        stripped_text: 'Subroutine All ice has +3 strength for the remainder of this run.',
        stripped_title: 'Red Tape',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'When you rez this ice, choose 1 installed program hosted on a piece of ice. Host that program on this ice. Each hosted program loses all abilities and cannot gain abilities. Subroutine End the run.',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine The Runner must pay 1 credit or trash 1 of their installed cards. Subroutine The Runner must pay 1 credit or trash 1 of their installed cards.',
        stripped_title: 'Fairchild 1.0',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          "Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine Trace[4]. If successful, add 1 installed program to the bottom of the Runner's stack. Subroutine Trace[4]. If successful, add 1 installed program to the bottom of the Runner's stack. Subroutine Give the Runner 1 tag.",
        stripped_title: 'Sherlock 2.0',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'While the Runner is accessing this ice in R&D, they must reveal it. When the Runner accesses this ice anywhere except in Archives, they encounter it. Subroutine Do 2 net damage.',
        stripped_title: 'Chrysalis',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine The Runner must pay 2 credits or trash 1 of their installed cards. Subroutine The Runner must pay 2 credits or trash 1 of their installed cards. Subroutine Do 1 core damage.',
        stripped_title: 'Fairchild 2.0',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine You and the Runner secretly spend 0 credits, 1 credit, or 2 credits. Reveal spent credits. If you and the Runner spent a different number of credits, the Runner draws 2 cards. Subroutine Do 1 net damage. Subroutine Do 1 net damage.',
        stripped_title: 'Aiki',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Lose click click click: Break up to 3 subroutines on this ice. Only the Runner can use this ability. Subroutine The Runner must pay 3 credits or trash 1 of their installed cards. Subroutine The Runner must pay 3 credits or trash 1 of their installed cards. Subroutine Do 1 core damage or end the run.',
        stripped_title: 'Fairchild 3.0',
      ...
      },
      {
        ...
        faction_cost: 3,
        flavor:
          'When your ID is flagged with your genetic profile, "privacy"  doesn\'t really exist.',
        illustrator: 'A. Jones',
        keywords: 'Code Gate - AP',
        pack_code: 'es',
        position: 53,
        ...
        strength: 6,
        stripped_text:
          'Subroutine Do 1 net damage. The Runner loses 2 credits. Subroutine Do 1 net damage. The Runner loses 2 credits. Subroutine Do 1 net damage. The Runner loses 2 credits.',
        stripped_title: 'DNA Tracker',
      ...
      },
      {
        ...
        strength: 8,
        stripped_text:
          'When the Runner encounters this ice, they take 1 tag unless they pay 3 credits. Subroutine End the run if the Runner is tagged. Subroutine End the run if the Runner is tagged. Subroutine End the run if the Runner is tagged. Subroutine End the run if the Runner is tagged.',
        stripped_title: 'Data Ward',
      ...
      },
      {
        ...
        strength: 8,
        stripped_text:
          'When you rez this ice, take 1 bad publicity. When the Runner encounters this ice, if there is an installed AI program, gain 2 credits. Subroutine The Runner trashes 1 installed program. Subroutine Gain 2 credits. End the run. Subroutine Gain 2 credits. End the run.',
        stripped_title: 'Bulwark',
      ...
      },
      {
        ...
        strength: 8,
        stripped_text:
          'Subroutine End the run unless the Runner pays 4 credits. Subroutine End the run unless the Runner pays 4 credits. Subroutine End the run unless the Runner trashes 1 of their installed cards. Subroutine End the run unless the Runner suffers 1 core damage.',
        stripped_title: 'Fairchild',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'When the Runner encounters this ice, give them 1 tag. Subroutine Trace[4]. If successful, do 1 net damage for each tag the Runner has. Subroutine Trace[4]. If successful, the Runner loses 1 credit for each tag they have.',
        stripped_title: 'Thoth',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'While the Runner is accessing this ice in R&D, they must reveal it. When the Runner accesses this ice anywhere except in Archives, they encounter it. Subroutine Trash 1 installed program.',
        stripped_title: 'Sapper',
        text: 'While the Runner is accessing this ice in R&D, they must reveal it.\nWhen the Runner accesses this ice anywhere except in Archives, they encounter it.\n[subroutine] Trash 1 installed program.',
        title: 'Sapper',
        trash_cost: 2,
        type_code: 'ice',
      ...
      },
      {
        ...
        strength: 8,
        stripped_text:
          "Whenever the Runner breaks a subroutine on Chiyashi while there is an AI installed, trash the top 2 cards of the Runner's stack. Subroutine Do 2 net damage. Subroutine Do 2 net damage. Subroutine End the run.",
        stripped_title: 'Chiyashi',
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'While the Runner is accessing this ice in R&D, they must reveal it. When the Runner accesses this ice anywhere except in Archives, they encounter it. Subroutine Gain 2 credits. Subroutine You may pay up to 2 credits to place that many advancement counters on 1 installed card you can advance.',
        stripped_title: 'Herald',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Subroutine The Corp gains 2 credits. Subroutine The Runner loses 2 credits. Subroutine Trace[2]. If successful, give the Runner 1 tag.',
        stripped_title: 'Veritas',
      ...
      },
      {
        ...
        faction_code: 'neutral-corp',
        faction_cost: 0,
        flavor: 'One way to get rid of a virus is to get a nastier virus.',
        illustrator: 'Mia Siergiejew',
        keywords: 'Code Gate - Tracer',
        pack_code: 'qu',
        position: 119,
        ...
        strength: 7,
        stripped_text:
          'Subroutine Trace[4]. If successful, purge virus counters. Subroutine Trace[3]. If successful, trash 1 virus. Subroutine Trace[2]. If successful, remove a virus in the heap from the game. Subroutine Trace[1]. If successful, end the run.',
        stripped_title: 'Macrophage',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine The Runner trashes 1 of their installed cards. Subroutine The Runner trashes 1 of their installed cards. Subroutine The Runner trashes 1 of their installed cards.',
        stripped_title: 'Tribunal',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine Trash 1 installed piece of hardware. Subroutine Trash 1 installed piece of hardware. Subroutine If the Runner has lost click to break a subroutine during this run, do 2 core damage.',
        stripped_title: 'Zed 2.0',
      ...
      },
      {
        ...
        faction_code: 'jinteki',
        faction_cost: 3,
        flavor: '"The ultimate aim of martial arts is not having to use them." - Miyamoto Musashi',
        illustrator: 'Adam S. Doyle',
        keywords: 'Barrier - AP',
        pack_code: 'dc',
        position: 13,
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'When the Runner passes Kakugo, do 1 net damage. Subroutine End the run.',
        stripped_title: 'Kakugo',
      ...
      },
      {
        ...
        faction_code: 'nbn',
        faction_cost: 3,
        flavor: '"\'What does BRE stand for?\' Have you seen its Net presence?" -Bernice Mai',
        illustrator: 'Liiga Smilshkalne',
        keywords: 'Sentry - Tracer',
        pack_code: 'dc',
        position: 15,
        ...
        strength: 6,
        stripped_text:
          'Subroutine Trace[4]. If successful, give the Runner 1 tag. Subroutine Trace[2]. If successful, whenever the Runner breaches a server for the remainder of this run, they access 1 fewer card.',
        stripped_title: 'SYNC BRE',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Seidr Adaptive Barrier has +1 strength for each piece of ice protecting this server. Subroutine End the run.',
        stripped_title: 'Seidr Adaptive Barrier',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine Do 1 core damage. You may draw 1 card. Subroutine Do 1 core damage. You may draw 1 card.',
        stripped_title: 'Nerine 2.0',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine You may install 1 piece of ice from HQ protecting another server, ignoring all costs. Subroutine You may install 1 piece of ice from HQ directly inward from this ice, ignoring all costs.',
        stripped_title: 'Bloom',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Hosted power counter: The Runner loses 1 credit. Subroutine Place 1 power counter on Free Lunch. Subroutine Place 1 power counter on Free Lunch.',
        stripped_title: 'Free Lunch',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 3,
        stripped_text: 'Subroutine Search R&D for a card and add it to HQ. Shuffle R&D.',
        stripped_title: 'Watchtower',
      ...
      },
      {
        ...
        strength: 1,
        stripped_text:
          'The strength of Self-Adapting Code Wall cannot be lowered. Subroutine End the run.',
        stripped_title: 'Self-Adapting Code Wall',
      ...
      },
      {
        ...
        faction_code: 'haas-bioroid',
        faction_cost: 1,
        flavor: '"I passed through the opalescent curtain only to find a suddenly empty server..."',
        illustrator: 'Michał Miłkowski',
        ...
        strength: 3,
        stripped_text:
          'This ice gains "Subroutine You may install 1 card from HQ." for each rezzed piece of NEXT ice.',
        stripped_title: 'NEXT Opal',
      ...
      },
      {
        ...
        faction_code: 'nbn',
        faction_cost: 1,
        flavor: '"I\'m sure there is no way this could go wrong for you." -Henry Phillips',
        illustrator: 'Mia Siergiejew',
        keywords: 'Code Gate',
        pack_code: 'eas',
        position: 55,
        ...
        strength: 4,
        stripped_text:
          'When the Runner encounters this ice, they may take 1 tag to bypass it. Subroutine The Corp gains 2 credits. Subroutine End the run.',
        stripped_title: 'Authenticator',
      ...
      },
      {
        ...
        faction_code: 'weyland-consortium',
        faction_cost: 4,
        flavor: '"Our job is to stop incursions. Let Argus get cute with them." -Moishe Saban',
        ...
        side_code: 'corp',
        strength: 2,
        stripped_text: 'Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Battlement',
        text: '[subroutine]End the run.\n[subroutine]End the run.',
        title: 'Battlement',
        type_code: 'ice',
        uniqueness: false,
      },
      {
        ...
        faction_code: 'neutral-corp',
        faction_cost: 0,
        flavor: '"It\'s eyes just keep following you."',
        illustrator: 'Liiga Smilshkalne',
        keywords: 'Sentry',
        pack_code: 'eas',
        position: 60,
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'Subroutine Add 1 installed program to the top of the stack.',
        stripped_title: 'Owl',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'When the Runner encounters this ice, choose another rezzed piece of ice. For the remainder of this run, this ice gains the subtypes of the chosen ice and gains the subroutines of that ice in order before its other subroutines. Subroutine End the run unless the Runner shuffles all cards from the grip into the stack.',
        stripped_title: 'Loki',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Whenever an encounter with this ice ends, if the Runner broke its printed subroutine, the Runner moves to the outermost position of Archives instead of passing this ice. They may jack out. Derez this ice. Subroutine You may draw 1 card. Then, shuffle 1 card from HQ into R&D.',
        stripped_title: 'Miraju',
      ...
      },
      {
        ...
        faction_cost: 3,
        flavor:
          '"My gift to runners: isomorphic architectural protocols. Ichiban daikirai da." -Midori',
        illustrator: 'Adam S. Doyle',
        keywords: 'Code Gate - Observer',
        pack_code: 'fm',
        position: 94,
        ...
        strength: 4,
        stripped_text:
          'Subroutine Swap 2 other installed pieces of ice or 2 of your installed non-ice cards.',
        stripped_title: 'Metamorph',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'When the Runner encounters this ice, they add 2 cards from the grip to the top of the stack. Subroutine End the run if the Runner is tagged. Subroutine End the run.',
        stripped_title: 'Data Loop',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'You may forfeit an agenda to rez Tithonium instead of paying its rez cost. Tithonium cannot host cards. Subroutine Trash 1 program. Subroutine Trash 1 program. Subroutine Trash 1 resource and end the run.',
        stripped_title: 'Tithonium',
      ...
      },
      {
        ...
        faction_cost: 0,
        flavor:
          'A ghost image of it could be made out in the static of his BMI. He hoped never to run across the real thing again.',
        illustrator: 'Ethan Patrick Harris',
        keywords: 'Code Gate',
        pack_code: 'cd',
        position: 120,
        ...
        strength: 4,
        stripped_text:
          'Conundrum has +3 strength if there is an installed AI. Subroutine The Runner trashes an installed program. Subroutine The Runner loses click, if able. Subroutine End the run.',
        stripped_title: 'Conundrum',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Lose click click: Break up to 2 subroutines on this ice. Only the Runner can use this ability. Subroutine You may draw 1 card. Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Eli 2.0',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'Subroutine Trace[4]. If successful, do 1 core damage.',
        stripped_title: 'Executive Functioning',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine Trace[4]. If successful, the Runner cannot access cards or breach the attacked server for the remainder of this run. Subroutine Trash 1 installed icebreaker.',
        stripped_title: 'Holmegaard',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'Subroutine The Runner loses click, if able. Subroutine The Corp may draw 1 card. Subroutine The Corp may add 1 card from HQ to the top of R&D.',
        stripped_title: 'Tapestry',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine The Runner must trash either 1 installed program or the top 2 cards of the stack.',
        stripped_title: 'Bloodletter',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine Remove a card in the heap from the game. Subroutine End the run.',
        stripped_title: 'Hailstorm',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine The Runner loses click. Subroutine The Runner trashes 1 card from their grip.',
        stripped_title: 'Weir',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Trash 1 program. Subroutine Trash 1 program. Subroutine Trash 1 piece of hardware. Subroutine The Runner loses 3 credits, if able. End the run.',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Trash 1 resource. Subroutine Trash 1 resource. Subroutine Do 1 net damage. Subroutine The Runner loses click, if able. End the run.',
      ...
      },
      {
        ...
        faction_code: 'haas-bioroid',
        faction_cost: 2,
        flavor: 'Earth and Sun, together as one.',
        illustrator: 'Andreas Zafiratos',
        keywords: 'Barrier - Bioroid',
        pack_code: 'ss',
        position: 11,
      ...
      },
      {
        ...
        faction_code: 'jinteki',
        faction_cost: 2,
        flavor: 'Thin enough to pierce netspace. Deadly enough to pierce your mind.',
        illustrator: 'Liiga Smilshkalne',
        ...
        strength: 3,
        stripped_text:
          'Subroutine You and the Runner secretly spend 0 credits, 1 credit or 2 credits. Reveal spent credits. If you and the Runner spend a different number of credits, do 2 net damage; otherwise do 1 net damage. Trash Mganga.',
        stripped_title: 'Mganga',
      ...
      },
      {
        ...
        faction_code: 'haas-bioroid',
        faction_cost: 3,
        flavor: 'Witchcraft to the nescient; beauty to the wise.',
        ...
        strength: 4,
        stripped_text:
          'Subroutine The Runner loses click, if able. You have an additional click to spend during your next turn. Subroutine The Runner loses click, if able. You have an additional click to spend during your next turn.',
        stripped_title: 'Nightdancer',
      ...
      },
      {
        ...
        side_code: 'corp',
        strength: 1,
        stripped_text: 'Subroutine Trash the top 3 cards of the stack. Trash Aimor.',
        stripped_title: 'Aimor',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'When the Runner encounters this ice, they cannot install cards for the remainder of the turn. Subroutine Choose 2 installed Runner cards, if able. The Runner must add 1 of the chosen cards to the top of the stack.',
        stripped_title: 'Jua',
      ...
      },
      {
        ...
        faction_code: 'haas-bioroid',
        faction_cost: 3,
        flavor: 'Every level of protection for all of your security needs.',
        illustrator: 'Ed Mattinian',
        keywords: 'Code Gate - NEXT',
        pack_code: 'cotc',
        position: 50,
        ...
        strength: 2,
        stripped_text:
          'X is the number of rezzed NEXT ice. Subroutine Draw up to X cards. Subroutine Add up to X cards from Archives to HQ. Subroutine Shuffle up to X cards from HQ into R&D.',
        stripped_title: 'NEXT Sapphire',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Whenever an encounter with this ice ends, if the Runner did not fully break it, do 3 net damage. Subroutine Look at the top 5 cards of R&D and arrange them in any order. Subroutine You may draw 1 card. The Runner may pay 2 credits to draw 1 card. Subroutine Do 1 net damage.',
        stripped_title: 'Anansi',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine Look at the top 3 cards of R&D and either arrange them in any order or shuffle R&D. You may draw 1 card. Subroutine You may trash 1 card in HQ. If you do, trash 1 resource. Trash Sadaka.',
        stripped_title: 'Sadaka',
      ...
      },
      {
        ...
        faction_code: 'nbn',
        faction_cost: 2,
        flavor: '"Has anyone ever actually read one of these things?" - 419',
        illustrator: 'Ed Mattinian',
        keywords: 'Barrier',
        pack_code: 'tdatd',
        position: 74,
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Subroutine Add an installed Runner card to the grip. Subroutine Add an installed Runner card to the grip.',
        stripped_title: 'Sandman',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'When the Runner encounters Oduduwa, place 1 advancement token on it. You may place X advancement tokens on another piece of ice. X is the number of advancement tokens on Oduduwa. Subroutine End the run. Subroutine End the run.',
        stripped_title: 'Oduduwa',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'Lose click: Break 1 subroutine on this ice. Only the Runner can use this ability. Subroutine Do 1 core damage unless the Runner trashes 1 installed resource. Subroutine Do 1 core damage unless the Runner trashes 1 installed piece of hardware. Subroutine Do 1 core damage unless the Runner trashes 1 installed program.',
        stripped_title: 'Kamali 1.0',
      ...
      },
      {
        ...
        faction_cost: 2,
        flavor:
          '"On one hand, I knew I shouldn\'t touch it. On the other, it was really shiny." - Kabonesa Wu',
        illustrator: 'Pavel Kolomeyets',
        keywords: 'Barrier - AP',
        pack_code: 'win',
        position: 95,
        ...
        side_code: 'corp',
        strength: 3,
        stripped_text: 'Subroutine Do 1 net damage. Subroutine End the run.',
        stripped_title: 'Envelope',
      ...
      },
      {
        ...
        strength: 3,
        stripped_text:
          'You can advance this ice. When you rez this ice, place 1 advancement counter on it. This ice gains "Subroutine End the run." for each hosted advancement counter.',
        stripped_title: 'Masvingo',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'The rez cost of this ice is lowered by 1 credit for each other rezzed piece of NEXT ice. Subroutine Do 1 core damage. Subroutine Do 1 core damage. Subroutine Trash 1 installed Runner card.',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine Do 1 net damage unless the Runner trashes the top 2 cards of the stack. Subroutine Do 2 net damage unless the Runner trashes the top 3 cards of the stack. Subroutine Do 3 net damage unless the Runner trashes the top 4 cards of the stack.',
        stripped_title: 'Mlinzi',
      ...
      },
      {
        ...
        strength: null,
        stripped_text:
          'X is twice the number of ice protecting this server. Subroutine Trace[X]. If successful, give the Runner 2 tags. Subroutine Trace[X]. If successful, end the run.',
        stripped_title: 'Surveyor',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'Subroutine Gain 4 credits and end the run unless the Runner adds this ice to their score area as an agenda worth -1 agenda point.',
        stripped_title: 'Meridian',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'Gatekeeper has +6 strength if you rezzed it this turn. Subroutine Draw up to 3 cards. Reveal up to 3 agendas in HQ and/or Archives, then shuffle those agendas into R&D. Subroutine End the run.',
        stripped_title: 'Gatekeeper',
      ...
      },
      {
        ...
        strength: 5,
        stripped_text:
          'Subroutine You may place up to 3 advancement counters on 1 card installed in the root of a remote server. If you do, the Runner accesses that card unless they pay 3 credits.',
        stripped_title: 'Otoroshi',
      ...
      },
      {
        ...
        strength: 0,
        stripped_text:
          'When your turn begins and whenever the Runner passes this ice, you may swap this ice with another installed piece of ice. Subroutine End the run.',
        stripped_title: 'Thimblerig',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'When the Runner encounters this ice, choose a card type, then reveal all cards in the grip. For the remainder of this run, this ice gains "Subroutine End the run unless the Runner takes 1 tag." for each revealed card of the chosen type.',
        stripped_title: 'Peeping Tom',
      ...
      },
      {
        ...
        strength: 6,
        stripped_text:
          'Subroutine Do 3 net damage if the Runner is tagged; otherwise, give the Runner 1 tag. Subroutine Gain 5 credits if the Runner is tagged; otherwise, give the Runner 1 tag. Subroutine End the run if the Runner is tagged; otherwise, give the Runner 1 tag.',
        stripped_title: 'Hydra',
      ...
      },
      {
        ...
        strength: 4,
        stripped_text:
          'This ice gains "Subroutine Gain 1 credit and the Runner loses 1 credit." before its other subroutines for every 2 faceup transaction operations in Archives. Subroutine Gain 1 credit and the Runner loses 1 credit. Subroutine End the run.',
        stripped_title: 'Blockchain',
      ...
      },
      {
        ...
        strength: 2,
        stripped_text:
          'Whenever the Runner approaches a server, you may rez this ice. If you do, move this ice to the innermost position protecting the approached server. The Runner moves to this ice and encounters it. Subroutine End the run unless the Runner suffers 2 net damage.',
        stripped_title: 'Formicary',
      ...
      },
      {
        ...
        faction_code: 'nbn',
        faction_cost: 1,
        flavor: '<strong>Designed by 2017 World Champion Jess Horig</strong>',
        illustrator: 'Ed Mattinian',
        keywords: 'Code Gate',
        pack_code: 'mo',
        position: 3,
      ...
      },
      {
        ...
        faction_code: 'weyland-consortium',
        faction_cost: 3,
        flavor: '<strong>Designed by 2016 World Champion Chris Dyer</strong>',
        illustrator: 'Adam S. Doyle',
        keywords: 'Barrier',
        pack_code: 'mo',
        position: 4,
        ...
        strength: 1,
        stripped_text:
          'trash: End the run. Use this ability only during a run on this server. Subroutine Gain 1 credit for each piece of ice protecting this server. Subroutine End the run.',
        stripped_title: 'Border Control',
      ...
      },
      {
        ...
        faction_code: 'nbn',
        faction_cost: 2,
        flavor: 'The original Net pathways were free and open. An unacceptable state of affairs.',
        illustrator: 'N. Hopkins',
        keywords: 'Code Gate',
        pack_code: 'su21',
        position: 66,
    ...
    console.log('s', JSON.stringify(ice));
    // });
  }
  ...
  private extractIceData(card: ApiCard): ParsedIce {
    return {
      ...
      cost: card.cost,
      text: card.text,
      encounterEffect: this.getEncounterCost(card),
  ...
  private getEncounterCost(card: ApiCard) {
    return '';
  }

  private getIceSubroutines(text: string) {
    const regex = /\[subroutine\]\s*([\s\S]*?)(?=\s*\[subroutine\]|\s*$)/gi;
